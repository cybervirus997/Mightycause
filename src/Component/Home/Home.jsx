    ...
    <div className={styles.header}>
      ...
      <div className={styles.afterNav}>
        <div>
          ...
          <p>
            Mightycause is a modern, all-in-one platform for nonprofit
            fundraising, donor management, marketing, peer-to-peer fundraising
            and more.
          </p>
          <Link to='/Contact-Us'>
      ...
      <div className={styles.middle}>
        <div>
          ...
          <p>
            It's time to start thinking beyond basic transaction processing like
            PayPal. Mightycause helps you develop lasting supporter
            relationships while saving money.
          </p>
        </div>
        <div className={styles.middleImage}>
          <img
            ...
            src='https://imagecdn.mightycause.com/e6d34664-fde7-49dd-ad30-f807e8449450/-/format/auto/-/progressive/yes/-/stretch/off/-/quality/smart/-/resize/926x/'></img>
        </div>
