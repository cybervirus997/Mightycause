    ...
    <div>
      ...
      <Wrapper>
        <Fundrasingsolution
          ...
          svg={
            <svg
              class="svg-inline--fa fa-donate fa-w-16"
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
              data-icon="donate"
          ...
          svg1={
            <svg
              style={{
                background: "linear-gradient(to top right, #cc00ff 0%, #ff6699 100%);",
                fill: "#D0A5F4",
              }}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 406 45"
            >
              <defs>
                ...
                <linearGradient id="linear-gradient" gradientUnits="objectBoundingBox">
                  <stop offset="0" stop-color="#688eff"></stop>
                  <stop offset="1" stop-color="#ffafef"></stop>
                </linearGradient>
              </defs>
              <path
                class="cls-1"
                d="M2915-11269l45-45,45,45,45-45,44,45,45-45,45,45,45-45,45,45,45-45h2"
                transform="translate(-2915 11314)"
              ></path>
            </svg>
          }
        />
        ...
        <Fundrasingsolution
          ...
          svg1={
            <svg
              style={{
                background:
                  "linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(207,129,77,1) 0%, rgba(241,94,31,1) 45%, rgba(252,176,69,1) 100%)",
                fill: "#FFCF36",
              }}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 406 45"
