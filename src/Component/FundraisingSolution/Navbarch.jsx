    ...
    <>
      <Nav>
        ...
        <Logo className="lodo_div">
          <img
            src="https://d3ijyydjgkuejv.cloudfront.net/businesses/7/mighty-cause_toe.png"
            alt="Logo"
          />
        </Logo>
        <Search>
          ...
          <button
            style={
              search ? { outline: "none", border: "none" } : { transform: "translateX(198px)" }
            }
