    ...
    return width > 720 ? (
        <>
            <Nav>
                ...
                <Logo className="lodo_div">
                    <img src="https://d3ijyydjgkuejv.cloudfront.net/businesses/7/mighty-cause_toe.png" alt="Logo" />
        ...
        <div className={styles.smallNav}>
            ...
            <div>
                <ul>
                    <li >
                        <span class="material-icons-outlined"><ExploreIcon className="explore" /></span>
                    </li>
                    <li>
                        <span class="material-icons-round"><AddCircleOutlineIcon /></span>
                    </li>
                    <li>
                        <span class="material-icons-round"><SearchIcon /></span>
                    </li>
                    <li>
