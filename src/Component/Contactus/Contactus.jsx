...
export default function Contactus(props) {
  ...
  // cardfunctionality
  const func_head_data = [
    'I want to start a fundraiser.',
    "I'm an existing customer looking for help.",
  ];
  const func_body_data = [
    'Create a crowdfunding page. You can raise money for anything whether it’s a charitable cause, your own goals and needs, or raising money on behalf of someone in need.',
    'To get help or troubleshoot, find answers in our support center.',
  ];
  ...
  return (
    <>
      ...
      <div className={styles['middle-main-div']}>
        ...
        <div>
          <Cardfunctional
            titlefnc={func_head_data[0]}
            descriptionfnc={func_body_data[0]}
            btnfnc={func_button_data[0]}
          />
        </div>

        <div>
          <Cardfunctional
            titlefnc={func_head_data[1]}
            descriptionfnc={func_body_data[1]}
            btnfnc={func_button_data[1]}
          />
        </div>
      </div>
